...
{
    GAMEMODE_ADVENTURE,
    GAMEMODE_SURVIVAL_EASY_STAGE_1,
    GAMEMODE_SURVIVAL_EASY_STAGE_2,
    GAMEMODE_SURVIVAL_EASY_STAGE_3,
    GAMEMODE_SURVIVAL_EASY_STAGE_4,
    GAMEMODE_SURVIVAL_EASY_STAGE_5,
    GAMEMODE_SURVIVAL_EASY_STAGE_6,
    ...
    GAMEMODE_SURVIVAL_EXTREME_STAGE_1,
    GAMEMODE_SURVIVAL_EXTREME_STAGE_2,
    GAMEMODE_SURVIVAL_EXTREME_STAGE_3,
    GAMEMODE_SURVIVAL_EXTREME_STAGE_4,
    GAMEMODE_SURVIVAL_EXTREME_STAGE_5,
    GAMEMODE_SURVIVAL_EXTREME_STAGE_6,
...
enum HelmType
{
    ...
    HELMTYPE_WALLNUT = 8,
    HELMTYPE_TALLNUT = 9,
    HELMTYPE_BLACK_CONE = 10,
    HELMTYPE_BLACK_PAIL = 11,
    HELMTYPE_PUMPKIN = 12,
	HELMTYPE_GIGA_FOOTBALL = 13,
};
enum LawnMowerState
{
    MOWER_ROLLING_IN = 0,
...
enum ParticleEffect
{
    ...
    PARTICLE_FUMECLOUD_LEFT,
    PARTICLE_GLOOMCLOUD_RANGER,
	PARTICLE_ZOMBIE_BLACK_TRAFFIC_CONE,
    PARTICLE_ZOMBIE_BLACK_PAIL,
    PARTICLE_ZOMBIE_GIGA_HELMET,
    NUM_PARTICLES
};
enum PlantPriority
{
...
enum PlantingReason
{
    ...
    PLANTING_SUNSHROOM_LIMIT_REACHED
};
enum PlantRowType
{
    PLANTROW_DIRT = 0,
...
enum ProjectileType
{
    ...
    PROJECTILE_GRAPESHOT = 14,
    PROJECTILE_ICEPEA = 15,
    PROJECTILE_RED_FIRE_PEA = 16,
    PROJECTILE_BLUE_FIRE_PEA = 17,
    PROJECTILE_WHITE_FIRE_PEA = 18,
    PROJECTILE_BLUE_SPIKE = 19,
    PROJECTILE_BLACK_SPIKE = 20,
    PROJECTILE_BOUNCING_PEA = 21,
    PROJECTILE_RED_STAR = 22,
    PROJECTILE_ARMOR = 23,
    PROJECTILE_POISON_CABBAGE = 24,
    PROJECTILE_BIG_BUTTER = 25,
    PROJECTILE_BIG_PEA = 26,
    PROJECTILE_BIG_FIREPEA = 27,
    PROJECTILE_BLACK_FIRE_PEA = 28,
    PROJECTILE_BIG_POISON_CABBAGE = 29,
    PROJECTILE_ZOMBIE_SNOWPEA = 30,
    PROJECTILE_ZOMBIE_PUFF = 31,
    PROJECTILE_ZOMBIE_SPIKE = 32,
    PROJECTILE_ZOMBIE_STAR = 33,
    PROJECTILE_ZOMBIE_CABBAGE = 34,
    PROJECTILE_ZOMBIE_KERNEL = 35,
    PROJECTILE_ZOMBIE_BUTTER = 36,
    PROJECTILE_PEA_SNIPE = 37,
    NUM_PROJECTILES = 38
};
enum ReanimationType
{
    ...
    REANIM_RED_POTATO_MINE,
    REANIM_ICEPEA,
    REANIM_SUPER_CHOMPER,
    REANIM_HYPNOGIGA,
    REANIM_BOMBSQUASH,
    REANIM_BLACK_THREEPEATER,
    REANIM_BLUE_TORCHWOOD,
    REANIM_DOOM_NUT,
    REANIM_ICE_PLANTERN,
    REANIM_MAD_CACTUS,
    REANIM_SOUR_STARFRUIT,
    REANIM_POISONPULT,
    REANIM_CORROSION_GARLIC,
    REANIM_ABSOLUTELEAF,
    REANIM_COMMANDOPEA,
    REANIM_SHRINKING_VIOLET,
    REANIM_HATTREMWITCH,
    REANIM_PICKLEDPEPPER,
    REANIM_NIGHTCAP,
    REANIM_SWEETPOTATO,
    REANIM_SUNBEAN,
    REANIM_SUNBEAN_BOMB,
    REANIM_GENERALPEA,
    REANIM_SWEETEST_POTATO,
    REANIM_HATTREMSAGE,
    REANIM_DARKCAP,
...
enum SeedType
{
    ...
    ENUM_AUTO_VALUE(SEED_COMMANDOPEA)
    ENUM_AUTO_VALUE(SEED_SWEETPOTATO)
    ENUM_AUTO_VALUE(SEED_SHRINKING_VIOLET)
    ENUM_AUTO_VALUE(SEED_SPROUT)
    ENUM_AUTO_VALUE(SEED_HATTREMWITCH)
    ENUM_AUTO_VALUE(SEED_PICKLEDPEPPER)
    ENUM_AUTO_VALUE(SEED_NIGHTCAP)
    ...
    ENUM_AUTO_VALUE(SEED_FIRESHOOTER)
    ENUM_AUTO_VALUE(SEED_EXPLODE_O_NUT)
    ENUM_AUTO_VALUE(SEED_RED_POTATO_MINE)
    ENUM_AUTO_VALUE(SEED_ICEPEA)
    ENUM_AUTO_VALUE(SEED_SUPER_CHOMPER)
    ENUM_AUTO_VALUE(SEED_HYPNOGIGA)
    ENUM_AUTO_VALUE(SEED_BOMBSQUASH)
    ENUM_AUTO_VALUE(SEED_BLACK_THREEPEATER)
    ENUM_AUTO_VALUE(SEED_BLUE_TORCHWOOD)
    ENUM_AUTO_VALUE(SEED_DOOM_NUT)
    ENUM_AUTO_VALUE(SEED_ICE_PLANTERN)
    ENUM_AUTO_VALUE(SEED_MAD_CACTUS)
	ENUM_AUTO_VALUE(SEED_SOUR_STARFRUIT)
    ENUM_AUTO_VALUE(SEED_POISONPULT)
    ENUM_AUTO_VALUE(SEED_CORROSION_GARLIC)
    ENUM_AUTO_VALUE(SEED_ABSOLUTELEAF)
    ENUM_AUTO_VALUE(SEED_SUNBEAN_BOMB)
    ENUM_AUTO_VALUE(SEED_GENERALPEA)
    ENUM_AUTO_VALUE(SEED_SWEETEST_POTATO)
    ENUM_AUTO_VALUE(SEED_HATTREMSAGE)
    ENUM_AUTO_VALUE(SEED_DARKCAP)
    ENUM_AUTO_VALUE(SEED_SUPER_SPLITPEA)
...
enum ZombiePhase
{
    ...
    PHASE_SUNFLOWER_WALKING,
    PHASE_SUNFLOWER_STEALING,
    PHASE_SUNFLOWER_SPAWNING,
    PHASE_CHERRY_HEAD_EXPLODING,
    PHASE_POTATO_HEAD_EXPLODING,
    PHASE_CHOMPER_HEAD_BITING,
    PHASE_CHOMPER_HEAD_DIGESTING,
};
enum ZombieType
{
    ...
    ENUM_AUTO_VALUE(ZOMBIE_RED_NEWSPAPER)
    ENUM_AUTO_VALUE(ZOMBIE_RED_EYE_NEWSPAPER)
    ENUM_AUTO_VALUE(ZOMBIE_DOOR)
	ENUM_AUTO_VALUE(ZOMBIE_DOOR_CONEHEAD)
	ENUM_AUTO_VALUE(ZOMBIE_DOOR_BUCKETHEAD)
    ENUM_AUTO_VALUE(ZOMBIE_BLACK_CONEHEAD)
    ENUM_AUTO_VALUE(ZOMBIE_BLACK_BUCKETHEAD)
    ENUM_AUTO_VALUE(ZOMBIE_BLACK_DOOR)
    ...
    ENUM_AUTO_VALUE(ZOMBIE_ENRAGED_JACK)
    ENUM_AUTO_VALUE(ZOMBIE_BALLOON)
    ENUM_AUTO_VALUE(ZOMBIE_PURPLE_BALLOON)
    ENUM_AUTO_VALUE(ZOMBIE_BLACK_BALLOON)
    ...
    ENUM_AUTO_VALUE(ZOMBIE_GIGA_FOOTBALL)
    ...
    ENUM_AUTO_VALUE(ZOMBIE_REPEATER_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_SNOW_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_SUNFLOWER_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_CHERRY_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_POTATO_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_CHOMPER_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_SUNSHROOM_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_FUMESHROOM_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_GRAVEBUSTER_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_HYPNOSHROOM_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_SCAREDYSHROOM_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_ICESHROOM_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_DOOMSHROOM_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_THREEPEATER_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_PLANTERN_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_CACTUS_HEAD)
	ENUM_AUTO_VALUE(ZOMBIE_BLOVER_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_STARFRUIT_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_PUMPKIN_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_CABBAGEPULT_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_KERNELPULT_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_COFFEE_HEAD)
    ENUM_AUTO_VALUE(ZOMBIE_GARLIC_HEAD)
    ...
    ENUM_VALUE(NUM_ZOMBIES_IN_ALMANAC, ZOMBIE_GARLIC_HEAD + 1)
};
